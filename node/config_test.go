...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "jknetwork.ipc", false, filepath.Join(os.TempDir(), "jknetwork.ipc")},
		{"data", "jknetwork.ipc", false, "data/jknetwork.ipc"},
		{"data", "./jknetwork.ipc", false, "./jknetwork.ipc"},
		{"data", "/jknetwork.ipc", false, "/jknetwork.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "jknetwork.ipc", true, `\\.\pipe\jknetwork.ipc`},
		{"data", "jknetwork.ipc", true, `\\.\pipe\jknetwork.ipc`},
		{"data", `\\.\pipe\jknetwork.ipc`, true, `\\.\pipe\jknetwork.ipc`},
	}
