...
func (ec *Client) SyncProgress(ctx context.Context) (*jknetwork.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (jknetwork.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q jknetwork.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q jknetwork.FilterQuery, ch chan<- types.Log) (jknetwork.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q jknetwork.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg jknetwork.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg jknetwork.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg jknetwork.CallMsg) (uint64, error) {
...
func toCallArg(msg jknetwork.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
