...
import (
	...
	"github.com/jknetwork/jknetwork/v3/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an JKNetwork
...
func (gc *JKNetwork) startBloomHandlers() {
...
// for the JKNetwork header bloom filters, permitting blazing fast filtering.
