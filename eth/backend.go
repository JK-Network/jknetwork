...
// Package eth implements the JKNetwork protocol.
package eth
...
import (
	...
	"github.com/jknetwork/jknetwork/v3/accounts"
	"github.com/jknetwork/jknetwork/v3/accounts/keystore"
	"github.com/jknetwork/jknetwork/v3/common"
	"github.com/jknetwork/jknetwork/v3/consensus"
	"github.com/jknetwork/jknetwork/v3/consensus/clique"
	"github.com/jknetwork/jknetwork/v3/core"
	"github.com/jknetwork/jknetwork/v3/core/bloombits"
	"github.com/jknetwork/jknetwork/v3/core/rawdb"
	"github.com/jknetwork/jknetwork/v3/core/types"
	"github.com/jknetwork/jknetwork/v3/core/vm"
	"github.com/jknetwork/jknetwork/v3/eth/downloader"
	"github.com/jknetwork/jknetwork/v3/eth/filters"
	"github.com/jknetwork/jknetwork/v3/eth/gasprice"
	"github.com/jknetwork/jknetwork/v3/internal/ethapi"
	"github.com/jknetwork/jknetwork/v3/log"
	"github.com/jknetwork/jknetwork/v3/miner"
	"github.com/jknetwork/jknetwork/v3/node"
	"github.com/jknetwork/jknetwork/v3/p2p"
	"github.com/jknetwork/jknetwork/v3/params"
	"github.com/jknetwork/jknetwork/v3/rpc"
)
...
// JKNetwork implements the JKNetwork full node service.
type JKNetwork struct {
	config      *Config
...
func (gc *JKNetwork) AddLesServer(ls LesServer) {
	gc.lesServer = ls
	ls.SetBloomBitsIndexer(gc.bloomIndexer)
}

// New creates a new JKNetwork object (including the
// initialisation of the common JKNetwork object)
func New(sctx *node.ServiceContext, config *Config) (*JKNetwork, error) {
	if config.SyncMode == downloader.LightSync {
		return nil, errors.New("can't run eth.JKNetwork in light sync mode, use les.LightJKNetwork")
	}
	...
	log.Info("Initialising JKNetwork protocol", "versions", ProtocolVersions, "network", config.NetworkId, "dbversion", dbVer)

	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, JKNetwork %s only supports v%d", *bcVersion, params.Version, core.BlockChainVersion)
...
func (gc *JKNetwork) APIs() []rpc.API {
...
func (gc *JKNetwork) ResetWithGenesisBlock(gb *types.Block) {
	if err := gc.blockchain.ResetWithGenesisBlock(gb); err != nil {
		log.Error("Cannot reset with genesis block", "err", err)
	}
}

func (gc *JKNetwork) Etherbase() (eb common.Address, err error) {
	gc.lock.RLock()
...
func (gc *JKNetwork) isLocalBlock(block *types.Block) bool {
...
func (gc *JKNetwork) SetEtherbase(etherbase common.Address) {
	gc.lock.Lock()
	gc.etherbase = etherbase
	gc.lock.Unlock()
...
func (gc *JKNetwork) StartMining(threads int) error {
...
func (gc *JKNetwork) IsMining() bool      { return gc.miner.Mining() }
func (gc *JKNetwork) Miner() *miner.Miner { return gc.miner }

func (gc *JKNetwork) AccountManager() *accounts.Manager  { return gc.accountManager }
func (gc *JKNetwork) BlockChain() *core.BlockChain       { return gc.blockchain }
func (gc *JKNetwork) TxPool() *core.TxPool               { return gc.txPool }
func (gc *JKNetwork) EventMux() *core.InterfaceFeed      { return gc.eventMux }
func (gc *JKNetwork) Engine() consensus.Engine           { return gc.engine }
func (gc *JKNetwork) ChainDb() common.Database           { return gc.chainDb }
func (gc *JKNetwork) IsListening() bool                  { return true } // Always listening
func (gc *JKNetwork) EthVersion() int                    { return int(gc.protocolManager.SubProtocols[0].Version) }
func (gc *JKNetwork) NetVersion() uint64                 { return gc.networkId }
func (gc *JKNetwork) Downloader() *downloader.Downloader { return gc.protocolManager.downloader }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (gc *JKNetwork) Protocols() []p2p.Protocol {
	if gc.lesServer == nil {
...
// JKNetwork protocol implementation.
func (gc *JKNetwork) Start(srvr *p2p.Server) error {
