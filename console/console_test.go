...
import (
	...
	"github.com/jknetwork/jknetwork/v3/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an JKNetwork service within
	...
	if err = stack.Register(func(sctx *node.ServiceContext) (node.Service, error) { return eth.New(sctx, ethConf) }); err != nil {
		t.Fatalf("failed to register JKNetwork protocol: %v", err)
	}
