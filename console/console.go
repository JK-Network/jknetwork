...
import (
	...
	"github.com/jknetwork/jknetwork/v3/internal/jsre/deps"
	"github.com/jknetwork/jknetwork/v3/internal/web3ext"
...
func (c *Console) Welcome() {
	message := "Welcome to the JKNetwork JavaScript console!\n\n"
