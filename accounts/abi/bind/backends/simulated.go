...
import (
	...
	"github.com/jknetwork/jknetwork/v3/accounts/abi/bind"
	"github.com/jknetwork/jknetwork/v3/common"
	"github.com/jknetwork/jknetwork/v3/common/hexutil"
	"github.com/jknetwork/jknetwork/v3/common/math"
	...
	"github.com/jknetwork/jknetwork/v3/event"
...
func (b *SimulatedBackend) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	...
	return nil, false, jknetwork.NotFound
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call jknetwork.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call jknetwork.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call jknetwork.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call jknetwork.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query jknetwork.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query jknetwork.FilterQuery, ch chan<- types.Log) (jknetwork.Subscription, error) {
