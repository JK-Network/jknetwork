...
func (mc *mockCaller) CallContract(ctx context.Context, call jknetwork.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call jknetwork.CallMsg) ([]byte, error) {
