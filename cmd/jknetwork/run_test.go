...
import (
	...
	"github.com/jknetwork/jknetwork/v3/internal/cmdtest"
...
func init() {
	// Run the app if we've been exec'd as "geth-test" in runJKNetwork.
...
func runJKNetwork(t *testing.T, args ...string) *testgeth {
	tt := &testgeth{}
