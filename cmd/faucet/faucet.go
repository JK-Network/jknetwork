...
import (
	...
	"github.com/jknetwork/jknetwork/v3/goclient"
	"github.com/jknetwork/jknetwork/v3/les"
	"github.com/jknetwork/jknetwork/v3/log"
	"github.com/jknetwork/jknetwork/v3/netstats"
	"github.com/jknetwork/jknetwork/v3/node"
	"github.com/jknetwork/jknetwork/v3/p2p"
	"github.com/jknetwork/jknetwork/v3/p2p/discover"
	"github.com/jknetwork/jknetwork/v3/p2p/discv5"
	"github.com/jknetwork/jknetwork/v3/p2p/nat"
...
var (
	...
	netFlag     = flag.Uint64("network", 0, "Network ID to use for the JKNetwork protocol")
	...
	logFlag    = flag.Int("loglevel", 3, "Log level to use for JKNetwork and the faucet")
)
...
type request struct {
	...
	Account common.Address     `json:"account"` // JKNetwork address being funded
	Time    time.Time          `json:"time"`    // Timestamp when the request was accepted
	Tx      *types.Transaction `json:"tx"`      // Transaction funding the account
}

// faucet represents a crypto faucet backed by an JKNetwork light client.
type faucet struct {
	config *params.ChainConfig // Chain configurations for signing
	stack  *node.Node          // JKNetwork protocol stack
	client *goclient.Client    // Client connection to the JKNetwork chain
...
func newFaucet(genesis *core.Genesis, port int, enodes []*discv5.Node, network uint64, stats string, ks *keystore.KeyStore, index []byte) (*faucet, error) {
	...
	// Assemble the JKNetwork light client protocol
...
// close terminates the JKNetwork connection and tears down the faucet.
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		// Retrieve the JKNetwork address to fund, the requesting user and a profile picture
		var (
			username string
			avatar   string
...
// the username, avatar URL and JKNetwork address to fund on success.
func authGitHub(url string) (string, string, common.Address, error) {
	...
	// Iterate over all the files and look for JKNetwork addresses
	...
	if address == (common.Address{}) {
		return "", "", common.Address{}, errors.New("No JKNetwork address found to fund")
	}
...
func authTwitter(url string) (string, string, common.Address, error) {
	...
	// scrape it for the JKNetwork address and profile URL.
...
// returning the username, avatar URL and JKNetwork address to fund on success.
...
// authNoAuth tries to interpret a faucet request as a plain JKNetwork address,
