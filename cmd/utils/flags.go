...
import (
	...
	"github.com/jknetwork/jknetwork/v3/common/fdlimit"
	...
	"github.com/jknetwork/jknetwork/v3/core/state"
	"github.com/jknetwork/jknetwork/v3/core/vm"
	"github.com/jknetwork/jknetwork/v3/crypto"
	...
	"github.com/jknetwork/jknetwork/v3/ethdb"
	"github.com/jknetwork/jknetwork/v3/les"
	"github.com/jknetwork/jknetwork/v3/log"
	"github.com/jknetwork/jknetwork/v3/metrics"
	...
	"github.com/jknetwork/jknetwork/v3/p2p/netutil"
	"github.com/jknetwork/jknetwork/v3/params"
	whisper "github.com/jknetwork/jknetwork/v3/whisper/whisperv6"
...
// for JKNetwork and returns half of the allowance to assign to the database.
...
// RegisterEthService adds an JKNetwork client to the stack.
func RegisterEthService(ctx context.Context, stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the JKNetwork service: %v", err)
	}
}
...
// RegisterNetStatsService configures the JKNetwork Stats daemon and adds it to
// the given node.
func RegisterNetStatsService(stack *node.Node, cfg netstats.Config) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		// Retrieve both eth and les services
		var ethServ *eth.JKNetwork
		ctx.Service(&ethServ)

		var lesServ *les.LightJKNetwork
		ctx.Service(&lesServ)

		return netstats.New(cfg, ethServ, lesServ), nil
	}); err != nil {
		Fatalf("Failed to register the JKNetwork Stats service: %v", err)
	}
}
