...
import (
	...
	"github.com/jknetwork/jknetwork/v3/common/mclock"
...
// Service implements an JKNetwork netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server       // Peer-to-peer server to retrieve networking infos
	eth    *eth.JKNetwork      // Full JKNetwork service if monitoring a full node
	les    *les.LightJKNetwork // Light JKNetwork service if monitoring a light node
...
func New(cfg Config, ethServ *eth.JKNetwork, lesServ *les.LightJKNetwork) *Service {
