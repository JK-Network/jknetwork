...
// DefaultGenesisBlock returns the JKNetwork main net genesis block.
...
// DefaultTestnetGenesisBlock returns the JKNetwork Testnet network genesis block.
...
// DeveloperGenesisBlock returns the 'jknetwork --dev' genesis block. Note, this must
...
// LocalGenesisBlock returns the 'jknetwork --local' genesis block.
